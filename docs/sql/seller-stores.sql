...
CREATE TABLE seller_stores (
    ...
    customer_service_open_time VARCHAR(5) NULL,
    customer_service_close_time VARCHAR(5) NULL,
    customer_service_closed_days VARCHAR(255) NULL,
    customer_service_note VARCHAR(500) NULL,
