...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleAdminCancellationException(AdminCancellationException exception) {
    ...
    @ExceptionHandler(AdminSellerManagementException.class)
    public ResponseEntity<ApiResponse<?>> handleAdminSellerManagementException(
            AdminSellerManagementException exception
    ) {
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(ApiResponse.fail(exception.getMessage()));
    ...
    @ExceptionHandler(AdminSellerOperationException.class)
    public ResponseEntity<ApiResponse<?>> handleAdminSellerOperationException(
            AdminSellerOperationException exception
    ) {
    ...
    @ExceptionHandler(AdminProductOperationException.class)
    public ResponseEntity<ApiResponse<?>> handleAdminProductOperationException(
            AdminProductOperationException exception
    ) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ApiResponse.fail(exception.getMessage()));
    }
